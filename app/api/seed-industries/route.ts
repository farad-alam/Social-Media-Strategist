...
// ── All 12 industries with their full content ─────────────────────────────────
const industrySeeds = [
  {
    key: 'small-business',
    order: 1,
    ...
    cardDescription: 'Local growth strategies',
    challenges: ['Limited time and budget', 'Standing out locally', 'Inconsistent posting'],
    strategy: [
      'Focus on local SEO and Google Business',
      'Community-centric Facebook groups',
      'Authentic behind-the-scenes content on Instagram',
    ],
    articleSections: [
      {
  ...
  },
  {
    ...
    cardDescription: 'Drive online sales',
    ...
    strategy: [
      ...
      'TikTok trends for product virality',
    ],
    articleSections: [
      {
  ...
  },
  {
    ...
    cardDescription: 'Lead generation focus',
    ...
    strategy: [
      ...
      'Webinar and whitepaper lead magnets',
    ],
    articleSections: [
      {
  ...
  },
  {
    ...
    cardDescription: 'Personal branding',
    challenges: ['Imposter syndrome', 'Standing out in a crowded market', 'Converting followers to clients'],
    strategy: [
      'Vulnerability and story-driven posts',
      'Value-packed short-form video (Reels/TikTok)',
      'Facebook Groups for community nurturing',
    ],
    articleSections: [
      {
  ...
  },
  {
    ...
    cardDescription: 'Authority & reputation',
    challenges: ['Advertising regulations', 'Dry subject matter', 'Building approachability'],
    strategy: [
      'Answering common legal FAQs via video',
      'LinkedIn articles on industry changes',
  ...
  },
  {
    ...
    cardDescription: 'Foot traffic & bookings',
    challenges: ['Highly localized competition', 'Managing bad reviews', 'Consistent high-quality content'],
    strategy: [
      'Mouth-watering Instagram Reels & TikToks',
      'Local SEO and Google Business updates',
  ...
  },
  {
    ...
    cardDescription: 'Rapid brand awareness',
    ...
    strategy: [
      ...
      'Viral-focused TikTok campaigns',
  ...
  },
  {
    ...
    cardDescription: 'Visual storytelling',
  ...
  },
  {
    ...
    cardDescription: 'Community engagement',
    challenges: ['Limited resources', 'Asking for donations without fatigue', 'Communicating complex issues'],
    strategy: [
      'Impact storytelling and beneficiary highlights',
      'Peer-to-peer fundraising campaigns',
      'Corporate partnership spotlights',
    ],
    articleSections: [
      {
...
export async function GET() {
  ...
  if (!token) {
    return NextResponse.json(
      { success: false, message: 'Missing SANITY_API_WRITE_TOKEN environment variable.' },
      { status: 401 }
    )
  }
  ...
  try {
    ...
    for (const industry of industrySeeds) {
      const doc = {
        _id: `industry-page-${industry.key}`,
        _type: 'industryPage',
        key: industry.key,
        ...
        articleSections: industry.articleSections.map((section, sIdx) => ({
          _key: `section-${industry.key}-${sIdx}`,
          _type: 'section',
    ...
    return NextResponse.json({
      success: true,
      message: `Successfully seeded ${results.length} industry pages into Sanity!`,
      seeded: results,
    })
  } catch (error: any) {
