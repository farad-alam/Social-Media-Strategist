...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMessage("Something went wrong. Please try again or email me directly at hasan@socialmediastrategist.net.");
    } finally {
            ...
            <div className="lg:col-span-2 space-y-6">
              <ScrollReveal delay={150}>
                <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-8">
                  <h3 className="text-lg font-bold text-slate-900 mb-2">Connect Online</h3>
                  <p className="text-sm text-slate-500 mb-5">Get an instant reply or chat directly with me.</p>
                  <a href="https://wa.me/8801723667373" target="_blank" rel="noopener noreferrer" className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-green-50 text-green-700 font-bold text-sm hover:bg-green-100 transition-colors duration-200">
