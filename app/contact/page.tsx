              ...
              <ScrollReveal delay={450}>
                <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-8">
                  ...
                  <div className="flex gap-3">
                    ...
                    <a href="https://upwork.com/freelancers/abulhasan" target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-green-50 text-green-700 font-medium text-sm hover:bg-green-100 transition-colors duration-200">
