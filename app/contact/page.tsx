            ...
            <div className="lg:col-span-2 space-y-6">
              <ScrollReveal delay={150}>
                <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-8">
                  ...
                  <a href="https://wa.me/8801713646536" target="_blank" rel="noopener noreferrer" className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-green-50 text-green-700 font-bold text-sm hover:bg-green-100 transition-colors duration-200">
